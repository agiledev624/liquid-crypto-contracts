...
const want = web3.utils.toChecksumAddress("0x65d43b64e3b31965cd5ea367d4c2b94c03084797"); // Add the LP address.
const tombchef = web3.utils.toChecksumAddress("0x54aff400858dcac39797a81894d9920f16972d1d");
const additionalCustomer = web3.utils.toChecksumAddress("0xcc0a87F7e7c693042a9Cc703661F5060c80ACb43");
const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "ApeSwap MATIC-USDT TokenX", // Update the mooName.
  mooSymbol: "tokenXApeSwapMATIC-USDT", // Update the mooSymbol.
  delay: 3600,
};
...
const strategyParams = {
  ...
  chef: tombchef,
  unirouter: "0xc0788a3ad43d79aa53b09c2eacc313a787d1d607",
  ...
  additionalCustomer: "0x3b5CB46Db3a4Ff2Ba44ac3A11A35C9765bB6739b",
  outputToNativeRoute: ["0x5d47bAbA0d66083C52009271faF3F50DCc01023C", "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270"], // Add the route to convert from the reward token to the native token.
  rewardToOutputRoute: ["0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270", "0x5d47bAbA0d66083C52009271faF3F50DCc01023C"],
  outputToLp0Route: ["0x5d47bAbA0d66083C52009271faF3F50DCc01023C", "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270"], // Add the route to convert your reward token to token0.
  outputToLp1Route: [
