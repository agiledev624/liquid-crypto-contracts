...
const want = web3.utils.toChecksumAddress("0x0bfe6f893a6bc443b575ddf361a30f39aa03e59c"); // Add the LP address.
const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Boo wsHEC-FTM TokenX", // Update the mooName.
  mooSymbol: "tokenXBoowsHEC-FTM", // Update the mooSymbol.
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToNativeRoute: [BOO, FTM], // Add the route to convert from the reward token to the native token.
  outputToLp0Route: [BOO, FTM], // Add the route to convert your reward token to token0.
  outputToLp1Route: [BOO, FTM, wsHEC], // Add the route to convert your reward token to token1.
