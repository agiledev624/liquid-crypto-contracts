...
const want = web3.utils.toChecksumAddress("0xF65C1C0478eFDe3c19b49EcBE7ACc57BB6B1D713"); // Add the LP address.

const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Ape BANANA-BNB TokenX", // Update the mooName.
  mooSymbol: "tokenXApeBANANA-BNB", // Update the mooSymbol.
  delay: 21600,
};
...
const contractNames = {
  vault: "LiquidCVaultV4", // Add the vault name which will be deployed.
  strategy: "StrategyApeLP", // Add the strategy name which will be deployed along with the vault.
};
