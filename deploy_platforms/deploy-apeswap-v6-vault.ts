...
const want = web3.utils.toChecksumAddress("0xc0afb6078981629f7eae4f2ae93b6dbea9d7a7e9"); // Add the LP address.

const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Ape SHIB-BNB TokenX", // Update the mooName.
  mooSymbol: "tokenXAPESHIB-BNB", // Update the mooSymbol.
  delay: 21600,
};

const strategyParams = {
  want,
  poolId: 60, // Add the LP id.
  ...
  outputToNativeRoute: ["0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95", "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"], // Add the route to convert from the reward token to the native token.
  outputToLp0Route: [
    "0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95",
    "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c",
    "0x2859e4544C4bB03966803b044A93563Bd2D0DD4D",
  ], // Add the route to convert your reward token to token0.
  outputToLp1Route: [" 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95", "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"], // Add the route to convert your reward token to token1.
...
const contractNames = {
  ...
  strategy: "StrategyMasterChefApeLP", // Add the strategy name which will be deployed along with the vault.
};
