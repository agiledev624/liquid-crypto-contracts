...
const want = web3.utils.toChecksumAddress("0x0b655e7d966cb27998af94aa5719ab7bfe07d3b3"); // Add the LP address.
const tombchef = web3.utils.toChecksumAddress("0x8084936982d089130e001b470edf58faca445008");
const unirouter = web3.utils.toChecksumAddress("0x1421bde4b10e8dd459b3bcb598810b1337d56842");
const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Sushi cUSD-cEUR TokenX", // Update the mooName.
  mooSymbol: "tokenXSushicUSD-cEUR", // Update the mooSymbol.
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToNativeRoute: ["0x29dfce9c22003a4999930382fd00f9fd6133acd1", "0x471ece3750da237f93b8e339c536989b8978a438"], // Add the route to convert from the reward token to the native token.
  outputToLp0Route: [
...
const contractNames = {
  ...
  strategy: "StrategySushiNativeDualLP", // Add the strategy name which will be deployed along with the vault.
};
