...
const want = web3.utils.toChecksumAddress("0x4733bc45ef91cf7ccecaeedb794727075fb209f2"); // Add the LP address.
...
const vaultParams = {
  mooName: "Tomb TSHARE-FTM TokenX", // Update the mooName.
  mooSymbol: "tokenXTombTSHARE-FTM", // Update the mooSymbol.
  delay: 3600,
};
...
const strategyParams = {
  ...
  outputToNativeRoute: ["0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37", "0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83"], // Add the route to convert from the reward token to the native token.
  outputToLp0Route: ["0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37", "0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83"], // Add the route to convert your reward token to token0.
  outputToLp1Route: ["0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37"], // Add the route to convert your reward token to token1.
