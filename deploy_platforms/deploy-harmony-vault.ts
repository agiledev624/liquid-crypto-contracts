...
const want = web3.utils.toChecksumAddress("0xc3670b927eF42eed252e483e2446352C238D9905"); // Add the LP address.
const tombchef = web3.utils.toChecksumAddress("0x67dA5f2FfaDDfF067AB9d5F025F8810634d84287");
const unirouter = web3.utils.toChecksumAddress("0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506");
const shouldVerifyOnEtherscan = false;

const vaultParams = {
  mooName: "Sushi WBTC-ONE TokenX", // Update the mooName.
  mooSymbol: "tokenXSushiWBTC-ONE", // Update the mooSymbol.
  delay: 21600,
};

const strategyParams = {
  want,
  poolId: 5, // Add the LP id.
  chef: tombchef,
  unirouter: unirouter,
  ...
  outputToNativeRoute: ["0xBEC775Cb42AbFa4288dE81F387a9b1A3c4Bc552A", "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a"], // Add the route to convert from the reward token to the native token.
  nativeToOutputRoute: ["0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "0xBEC775Cb42AbFa4288dE81F387a9b1A3c4Bc552A"],
  outputToLp0Route: [
    "0xBEC775Cb42AbFa4288dE81F387a9b1A3c4Bc552A",
    "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a",
    "0x3095c7557bCb296ccc6e363DE01b760bA031F2d9",
  ], // Add the route to convert your reward token to token0.
  outputToLp1Route: ["0xBEC775Cb42AbFa4288dE81F387a9b1A3c4Bc552A", "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a"], // Add the route to convert your reward token to token1.
...
const contractNames = {
  ...
  strategy: "StrategyMiniChefLP", // Add the strategy name which will be deployed along with the vault.
};
...
async function main() {
  ...
  const strategyConstructorArguments = [
    ...
    strategyParams.nativeToOutputRoute,
