...
const want = web3.utils.toChecksumAddress("0x6ba3071760d46040fb4dc7b627c9f68efaca3000"); // Add the LP address.
const tombchef = web3.utils.toChecksumAddress("0xc6ca172fc8bdb803c5e12731109744fb0200587b");
const unirouter = web3.utils.toChecksumAddress("0x96b244391d98b62d19ae89b1a4dccf0fc56970c7");
const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Beam USDC-ETH TokenX", // Update the mooName.
  mooSymbol: "tokenXBeamUSDC-ETH", // Update the mooSymbol.
  delay: 21600,
};

const strategyParams = {
  want,
  poolId: 4, // Add the LP id.
  chef: tombchef,
  ...
  outputToNativeRoute: ["0xcd3b51d98478d53f4515a306be565c6eebef1d58", "0xacc15dc74880c9944775448304b263d191c6077f"], // Add the route to convert from the reward token to the native token.
  outputToLp0Route: [
...
const contractNames = {
  ...
  strategy: "StrategyBeamChefLP", // Add the strategy name which will be deployed along with the vault.
};
