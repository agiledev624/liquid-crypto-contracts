...
contract StrategyDFYNRewardPoolLP is StratManager, FeeManager {
    ...
    // Routes
    address[] public outputToNativeRoute; // since DFYN uses its own native, convert to common token, then convert that token to native LiquidC uses
    ...
    function chargeFees() internal {
        ...
        uint256 LiquidCFeeAmount = wmaticBal.mul(LiquidCFee).div(MAX_FEE);
