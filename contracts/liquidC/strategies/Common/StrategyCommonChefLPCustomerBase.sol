...
import "../Common/StratV2Manager.sol";
import "../Common/FeeV2Manager.sol";
import "../../utils/StringUtils.sol";
import "../../utils/GasThrottler.sol";

contract StrategyCommonChefLPCustomerBase is StratV2Manager, FeeV2Manager, GasThrottler {
    ...
    event ChargedFees(uint256 callFees, uint256 LiquidCFees, uint256 customerFees);
    ...
    constructor(
        ...
        address _additionalCustomer,
        address[] memory _outputToNativeRoute,
        address[] memory _outputToLp0Route,
        address[] memory _outputToLp1Route
    ) StratV2Manager(_keeper, _strategist, _unirouter, _vault, _LiquidCFeeRecipient, _additionalCustomer) public {
        want = _want;
        poolId = _poolId;
        chef = _chef;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        emit ChargedFees(callFeeAmount, LiquidCFeeAmount, customerFeeAmount);
    }
