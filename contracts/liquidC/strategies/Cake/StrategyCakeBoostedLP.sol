...
contract StrategyCakeBoostedLP is StratV2Manager, FeeV2Manager, GasThrottler {
    ...
    ) StratV2Manager(_keeper, _strategist, _unirouter, _vault, _LiquidCFeeRecipient, _additionalCustomerRecipient) public {
        want = _want;
        poolId = _poolId;
        chef = _chef;
