...
// File: contracts/BIFI/zap/LiquidCUniV2Zap.sol
...
contract LiquidCUniV2Zap {
    ...
    function beefOutAndSwap(address LiquidCVault, uint256 withdrawAmount, address desiredToken, uint256 desiredTokenOutMin) external {
        ...
        require(token0 == desiredToken || token1 == desiredToken, 'LiquidC: desired token not present in liqudity pair');
    ...
    function _swapAndStake(address LiquidCVault, uint256 tokenAmountOutMin, address tokenIn) private {
        ...
        require(isInputA || pair.token1() == tokenIn, 'LiquidC: Input token not present in liqudity pair');
    ...
    function checkWETH() public view returns (bool isValid) {
        ...
        require(isValid, 'LiquidC: WETH address not matching Router.WETH()');
    }
